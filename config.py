...
class Config:
    ...
    # PRO Monthly (£19.99/month) - previously labeled "MONTHLY"
    ...
    STRIPE_PREMIUM_PLUS_PRICE_ID = os.environ.get('STRIPE_PREMIUM_PLUS_PRICE_ID') or 'price_PREMIUM_PLUS_PLACEHOLDER'

    # Pricing (in pence)
    PRO_MONTHLY_PRICE = 1999  # £19.99/month
    PREMIUM_PRICE = 4999  # £49.99/month
